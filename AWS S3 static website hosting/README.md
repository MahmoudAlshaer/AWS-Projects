...
![Bucket Created](screenshots/Bucket_created.png)

### 2. Uploaded Website Files
Uploaded index.html to the bucket as the 
main entry point for the website.

![Objects Added](screenshots/Objects_added.png)

### 3. Enabled Static Website Hosting
Configured the bucket to host a static website 
with index.html as the index document.

![Static Website Hosting](screenshots/Static_website_hosting_enabled.png)
...
![403 Error](screenshots/403_Forbidden_Error.png)
